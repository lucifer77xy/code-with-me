...
import { Heart, Lock, Mail, Sparkles, ArrowRight, ShieldCheck, Github } from "lucide-react";
      ...
      <div className="relative w-full max-w-md rounded-3xl border border-white/10 bg-slate-900/90 p-8 backdrop-blur-2xl shadow-2xl shadow-rose-950/40 space-y-6">
        ...
        <div className="space-y-2.5">
          <button
            ...
            disabled={isLoading}
            className="w-full flex items-center justify-center gap-3 rounded-2xl border border-white/10 bg-white/5 py-3 text-xs font-bold text-white hover:bg-white/10 active:scale-95 transition-all shadow-sm"
          >
        ...
        <div className="text-center text-[11px] text-slate-500">
          <p>
            {isFirebaseActive
              ? "Connected with Firebase Authentication & Firestore Database."
              : "Firebase offline cache active. Ready for preview and instant testing."}
          </p>
